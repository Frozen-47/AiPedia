    ...
    <article
      ...
      className={`
        group flex flex-col rounded-xl p-5 cursor-pointer glow-card transition-all ${
          isNew
            ? "border-purple-500/30 ring-1 ring-purple-500/10 shadow-sm bg-purple-500/[0.01] hover:border-purple-500/40"
            : t.card
        }
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-1 flex-wrap justify-end">
          ...
          {isNew && (
            <span className="inline-flex items-center text-[8px] font-black uppercase px-2 py-0.5 rounded bg-purple-500/15 text-purple-400 border border-purple-500/25 animate-pulse">
              NEW
            </span>
          )}
          {entry.popular && (
